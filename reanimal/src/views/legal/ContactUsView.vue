      ...
      <div class="container">
        <div class="content-wrapper">
          <div class="legal-text">
            ...
            <h2>Email</h2>
            <p>
              For general inquiries, please email us at: <a href="mailto:wyong@reanimalgame.org">wyong@reanimalgame.org</a>
            </p>
            ...
            <ul>
              ...
              <li>General feedback about Reanimal Game Community</li>
            </ul>
            ...
            <h2>Thank You</h2>
            <p>
              Thank you for your interest in Reanimal Game Community. We look forward to hearing from you!
            </p>
          </div>
        </div>
      </div>
...
onMounted(() => {
  document.title = 'Contact Us - Reanimal Game - reanimalgame.org'
  ...
  metaDescription.setAttribute('content', 'Contact Reanimal Game Community. Get in touch with us for questions, suggestions, feedback, or inquiries about our website and services.')
  ...
  metaKeywords.setAttribute('content', 'contact Reanimal Game Community, Reanimal game support, Reanimal community contact')
})
</script>
